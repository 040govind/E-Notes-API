...
@GetMapping("/")
    ...
    public ResponseEntity<?> favouriteNote(@PathVariable Integer noteId) throws Exception{
		...
		return CommonUtil.createBuildResponseMessage("Note Added in Favourite", HttpStatus.CREATED);
	}
    ...
    public ResponseEntity<?> unFavouriteNote(@PathVariable Integer favNoteId) throws Exception{
		...
		return CommonUtil.createBuildResponseMessage("Note Remove from Favourite", HttpStatus.OK);
	}
